...
class RMGNGenerator(BaseNetwork):
    def __init__(self, multilevel=False, predmask=True):
        ...
        self.inp_encoder = AttrEncoder(nf=nf, in_nc=in_nc_clothes, head_layers=head_layers)
        self.ref_encoder = AttrEncoder(nf=nf, in_nc=in_nc_person, head_layers=head_layers)
